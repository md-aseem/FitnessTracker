...
void loadChillerCurves(struct SimMain *simmain)
{
   ...
   else if(strcmp("bergstrom_55kW",simmain->chillerModelName) == 0)
   {
      fprintf(LOGFILE," Using the Bergstrom 55kW Chiller\n\n");

                           /* ambient temp */  /* cooling power @ 18C */       /* compressor power @ 18C */
      c->cooling18[0][0]   = (-30.0 + 273.15);   c->cooling18[0][1]  = 70000.0;    c->cooling18[0][2]  = 13000.0;
      c->cooling18[1][0]   = (-10.0 + 273.15);   c->cooling18[1][1]  = 70000.0;    c->cooling18[1][2]  = 13000.0;
      c->cooling18[2][0]   = ( 00.0 + 273.15);   c->cooling18[2][1]  = 70000.0;    c->cooling18[2][2]  = 13000.0;
      c->cooling18[3][0]   = ( 05.0 + 273.15);   c->cooling18[3][1]  = 69000.0;    c->cooling18[3][2]  = 13000.0;
      c->cooling18[4][0]   = ( 15.0 + 273.15);   c->cooling18[4][1]  = 68000.0;    c->cooling18[4][2]  = 13200.0;
      c->cooling18[5][0]   = ( 20.0 + 273.15);   c->cooling18[5][1]  = 65000.0;    c->cooling18[5][2]  = 14800.0;
      c->cooling18[6][0]   = ( 25.0 + 273.15);   c->cooling18[6][1]  = 65000.0;    c->cooling18[6][2]  = 16800.0;
      c->cooling18[7][0]   = ( 30.0 + 273.15);   c->cooling18[7][1]  = 60000.0;    c->cooling18[7][2]  = 18800.0;
      c->cooling18[8][0]   = ( 35.0 + 273.15);   c->cooling18[8][1]  = 55000.0;    c->cooling18[8][2]  = 22200.0;
      c->cooling18[9][0]   = ( 40.0 + 273.15);   c->cooling18[9][1]  = 50000.0;    c->cooling18[9][2]  = 21700.0;
      c->cooling18[10][0]  = ( 45.0 + 273.15);   c->cooling18[10][1] = 38000.0;    c->cooling18[10][2] = 17200.0;
      c->cooling18[11][0]  = ( 50.1 + 273.15);   c->cooling18[11][1] = 26000.0;    c->cooling18[11][2] = 13200.0;

                        /* ambient temp */  /* cooling power @ 23C */       /* compressor power @ 23C */
      c->cooling23[0][0]   = (-30.0 + 273.15);   c->cooling23[0][1]  = 74000.0;    c->cooling23[0][2]  = 15750.0;
      c->cooling23[1][0]   = (-10.0 + 273.15);   c->cooling23[1][1]  = 74000.0;    c->cooling23[1][2]  = 15750.0;
      c->cooling23[2][0]   = ( 00.0 + 273.15);   c->cooling23[2][1]  = 74000.0;    c->cooling23[2][2]  = 15750.0;
      c->cooling23[3][0]   = ( 05.0 + 273.15);   c->cooling23[3][1]  = 73000.0;    c->cooling23[3][2]  = 16000.0;
      c->cooling23[4][0]   = ( 15.0 + 273.15);   c->cooling23[4][1]  = 72000.0;    c->cooling23[4][2]  = 17000.0;
      c->cooling23[5][0]   = ( 20.0 + 273.15);   c->cooling23[5][1]  = 69000.0;    c->cooling23[5][2]  = 17500.0;
      c->cooling23[6][0]   = ( 25.0 + 273.15);   c->cooling23[6][1]  = 66500.0;    c->cooling23[6][2]  = 18000.0;
      c->cooling23[7][0]   = ( 30.0 + 273.15);   c->cooling23[7][1]  = 62000.0;    c->cooling23[7][2]  = 19500.0;
      c->cooling23[8][0]   = ( 35.0 + 273.15);   c->cooling23[8][1]  = 59000.0;    c->cooling23[8][2]  = 21500.0;
      c->cooling23[9][0]   = ( 40.0 + 273.15);   c->cooling23[9][1]  = 52000.0;    c->cooling23[9][2]  = 21200.0;
      c->cooling23[10][0]  = ( 45.0 + 273.15);   c->cooling23[10][1] = 40000.0;    c->cooling23[10][2] = 17000.0;
      c->cooling23[11][0]  = ( 50.1 + 273.15);   c->cooling23[11][1] = 28000.0;    c->cooling23[11][2] = 13000.0;
   }
   else
   {
      fprintf(LOGFILE," The chiller name called out is not recognized\n");
      fprintf(LOGFILE," Recognized chiller names are:  envicool_55kW\n");
      fprintf(LOGFILE,"                                bergstrom_55kW\n");
