...
void initialize(struct SimMain *simmain)
{
   ...
   simmain->sunriseTime            = NO_INPUT; //SUNRISE_TIME_HOURS*CONVERT_HOURS_TO_SECONDS;
   simmain->sunsetTime             = NO_INPUT; //SUNSET_TIME_HOURS*CONVERT_HOURS_TO_SECONDS;
...
struct Chiller *initializeChiller(struct SimMain *simmain)
{
   ...
   /*                                         */
   /* updated based on data from Joe          */
   /* on October 1, 2025:                     */
                        /* ambient temp */  /* cooling power @ 18C */       /* compressor power @ 18C */
/*   p->cooling18[0][0]   = (-30.0 + 273.15);   p->cooling18[0][1]  = 52500.0;    p->cooling18[0][2]  = ZERO;
   p->cooling18[1][0]   = (-10.0 + 273.15);   p->cooling18[1][1]  = 52500.0;    p->cooling18[1][2]  = ZERO;
   p->cooling18[2][0]   = ( 00.0 + 273.15);   p->cooling18[2][1]  = 40000.0;    p->cooling18[2][2]  = ZERO;
   p->cooling18[3][0]   = ( 05.0 + 273.15);   p->cooling18[3][1]  = 40000.0;    p->cooling18[3][2]  = ZERO;
   p->cooling18[4][0]   = ( 15.0 + 273.15);   p->cooling18[4][1]  = 39000.0;    p->cooling18[4][2]  = 6830.0;
   p->cooling18[5][0]   = ( 20.0 + 273.15);   p->cooling18[5][1]  = 38500.0;    p->cooling18[5][2]  = 7565.0;
   p->cooling18[6][0]   = ( 25.0 + 273.15);   p->cooling18[6][1]  = 36250.0;    p->cooling18[6][2]  = 8300.0;
   p->cooling18[7][0]   = ( 30.0 + 273.15);   p->cooling18[7][1]  = 34000.0;    p->cooling18[7][2]  = 9220.0;
   p->cooling18[8][0]   = ( 35.0 + 273.15);   p->cooling18[8][1]  = 32000.0;    p->cooling18[8][2]  = 10140.0;
   p->cooling18[9][0]   = ( 40.0 + 273.15);   p->cooling18[9][1]  = 30000.0;    p->cooling18[9][2]  = 11170.0;
   p->cooling18[10][0]  = ( 45.0 + 273.15);   p->cooling18[10][1] = 28000.0;    p->cooling18[10][2] = 9190.0;
   p->cooling18[11][0]  = ( 50.1 + 273.15);   p->cooling18[11][1] = 18500.0;    p->cooling18[11][2] = 4660.0;
*/
                        /* ambient temp */  /* cooling power @ 23C */       /* compressor power @ 23C */
/*   p->cooling23[0][0]   = (-30.0 + 273.15);   p->cooling23[0][1]  = 55500.0;    p->cooling23[0][2]  = ZERO;
   p->cooling23[1][0]   = (-10.0 + 273.15);   p->cooling23[1][1]  = 55500.0;    p->cooling23[1][2]  = ZERO;
   p->cooling23[2][0]   = ( 00.0 + 273.15);   p->cooling23[2][1]  = 44000.0;    p->cooling23[2][2]  = ZERO;
   p->cooling23[3][0]   = ( 05.0 + 273.15);   p->cooling23[3][1]  = 44000.0;    p->cooling23[3][2]  = ZERO;
   p->cooling23[4][0]   = ( 15.0 + 273.15);   p->cooling23[4][1]  = 43000.0;    p->cooling23[4][2]  = 7080.0;
   p->cooling23[5][0]   = ( 20.0 + 273.15);   p->cooling23[5][1]  = 42000.0;    p->cooling23[5][2]  = 7910.0;
   p->cooling23[6][0]   = ( 25.0 + 273.15);   p->cooling23[6][1]  = 40000.0;    p->cooling23[6][2]  = 8770.0;
   p->cooling23[7][0]   = ( 30.0 + 273.15);   p->cooling23[7][1]  = 38000.0;    p->cooling23[7][2]  = 9425.0;
   p->cooling23[8][0]   = ( 35.0 + 273.15);   p->cooling23[8][1]  = 35000.0;    p->cooling23[8][2]  = 10625.0;
   p->cooling23[9][0]   = ( 40.0 + 273.15);   p->cooling23[9][1]  = 32000.0;    p->cooling23[9][2]  = 11560.0;
   p->cooling23[10][0]  = ( 45.0 + 273.15);   p->cooling23[10][1] = 29000.0;    p->cooling23[10][2] = 9103.0;
   p->cooling23[11][0]  = ( 50.1 + 273.15);   p->cooling23[11][1] = 18500.0;    p->cooling23[11][2] = 4298.0;
*/
   ...
   /*                                         */
                        /* ambient temp */  /* cooling power @ 18C */       /* compressor power @ 18C */
/*   p->cooling18[0][0]   = (-30.0 + 273.15);   p->cooling18[0][1]  = 70500.0;    p->cooling18[0][2]  = 16250.0;
   p->cooling18[1][0]   = (-10.0 + 273.15);   p->cooling18[1][1]  = 70500.0;    p->cooling18[1][2]  = 16250.0;
   p->cooling18[2][0]   = ( 00.0 + 273.15);   p->cooling18[2][1]  = 70500.0;    p->cooling18[2][2]  = 16250.0;
   p->cooling18[3][0]   = ( 05.0 + 273.15);   p->cooling18[3][1]  = 69000.0;    p->cooling18[3][2]  = 16500.0;
   p->cooling18[4][0]   = ( 15.0 + 273.15);   p->cooling18[4][1]  = 68000.0;    p->cooling18[4][2]  = 17500.0;
   p->cooling18[5][0]   = ( 20.0 + 273.15);   p->cooling18[5][1]  = 65000.0;    p->cooling18[5][2]  = 18000.0;
   p->cooling18[6][0]   = ( 25.0 + 273.15);   p->cooling18[6][1]  = 62500.0;    p->cooling18[6][2]  = 18500.0;
   p->cooling18[7][0]   = ( 30.0 + 273.15);   p->cooling18[7][1]  = 58000.0;    p->cooling18[7][2]  = 20000.0;
   p->cooling18[8][0]   = ( 35.0 + 273.15);   p->cooling18[8][1]  = 55000.0;    p->cooling18[8][2]  = 22000.0;
   p->cooling18[9][0]   = ( 40.0 + 273.15);   p->cooling18[9][1]  = 51000.0;    p->cooling18[9][2]  = 23500.0;
   p->cooling18[10][0]  = ( 45.0 + 273.15);   p->cooling18[10][1] = 46500.0;    p->cooling18[10][2] = 22500.0;
   p->cooling18[11][0]  = ( 50.1 + 273.15);   p->cooling18[11][1] = 30500.0;    p->cooling18[11][2] = 17500.0;
*/
                        /* ambient temp */  /* cooling power @ 23C */       /* compressor power @ 23C */
/*   p->cooling23[0][0]   = (-30.0 + 273.15);   p->cooling23[0][1]  = 72500.0;    p->cooling23[0][2]  = 15750.0;
   p->cooling23[1][0]   = (-10.0 + 273.15);   p->cooling23[1][1]  = 72500.0;    p->cooling23[1][2]  = 15750.0;
   p->cooling23[2][0]   = ( 00.0 + 273.15);   p->cooling23[2][1]  = 72500.0;    p->cooling23[2][2]  = 15750.0;
   p->cooling23[3][0]   = ( 05.0 + 273.15);   p->cooling23[3][1]  = 71000.0;    p->cooling23[3][2]  = 16000.0;
   p->cooling23[4][0]   = ( 15.0 + 273.15);   p->cooling23[4][1]  = 70000.0;    p->cooling23[4][2]  = 17000.0;
   p->cooling23[5][0]   = ( 20.0 + 273.15);   p->cooling23[5][1]  = 67000.0;    p->cooling23[5][2]  = 17500.0;
   p->cooling23[6][0]   = ( 25.0 + 273.15);   p->cooling23[6][1]  = 64500.0;    p->cooling23[6][2]  = 18000.0;
   p->cooling23[7][0]   = ( 30.0 + 273.15);   p->cooling23[7][1]  = 60000.0;    p->cooling23[7][2]  = 19500.0;
   p->cooling23[8][0]   = ( 35.0 + 273.15);   p->cooling23[8][1]  = 57000.0;    p->cooling23[8][2]  = 21500.0;
   p->cooling23[9][0]   = ( 40.0 + 273.15);   p->cooling23[9][1]  = 53000.0;    p->cooling23[9][2]  = 23000.0;
   p->cooling23[10][0]  = ( 45.0 + 273.15);   p->cooling23[10][1] = 48500.0;    p->cooling23[10][2] = 22000.0;
   p->cooling23[11][0]  = ( 50.1 + 273.15);   p->cooling23[11][1] = 32500.0;    p->cooling23[11][2] = 17000.0;
*/
   /*                                         */
   /*              QUANTUM HE                 */
...
//   p->totalBatteryEnergy       = 1331.2*314.0*12.0;  /* 1331.2 Volts * 314.0 A*hrs * 12 strings per container */
   p->totalBatteryEnergy       = (3.2*52.0)*(306.0*80.0);
   p->initialSoh               = ONE;
   p->soh                      = p->initialSoh;
