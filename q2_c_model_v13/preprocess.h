...
#define IS_THERE_AN_HVAC                    simmain->hvacPresent

/* total system energy in megawatt-hours */
#define TOTAL_SYSTEM_ENERGY                 (b->totalBatteryEnergy/1000000.0)
...
#define maxChargeRate                       simmain->cRate
#define maxDischargeRate                    simmain->dRate
...
#define cycleListHead                       simmain->cycle
...
enum Emain { FIXED_AMB_TEMP, INITIAL_TEMP, MAX_CHARGE_RATE, MAX_DISCHARGE_RATE, CHILLER_MODEL, CHILLER_NOISE_KIT, BATTERY_MODEL, HVAC_OPTION_PRESENT, TIME_OF_SUNRISE, TIME_OF_SUNSET, BATTERY_LIFE, INITIAL_SOC, POWER_FILE_NAME, HVAC_PRESENT, CYCLE_CALLOUT, IN_ANYmain };
